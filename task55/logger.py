...
#         #print(data_second)
#         result = (int(input(('что вы хотите изменить,1-имя, 2-фамилия,3-номер,4-адрес: '))))
#         if result == 1:
#             name  = data_second[number_journal].split(';')
#             name[result-1] = name_data()
#             data_second = data_second[:number_journal] + [f'{name};\n'] + \
#             data_second[number_journal + 1:]
#             with open('data_second_variant.csv', 'w', encoding='utf-8') as file:
#                 file.write(''.join(data_second))
#         if result == 2:
#             surname  = data_second[number_journal].split(';')
#             surname[result-1] = surname_data()
#             data_second = data_second[:number_journal] + [f'{surname};\n'] + \
#             data_second[number_journal + 1:]
#             with open('data_second_variant.csv', 'w', encoding='utf-8') as file:
#                 file.write(''.join(data_second))
#         if result == 3:
#             phone  = data_second[number_journal].split(';')
#             phone[result-1] =phone_data()
#             data_second = data_second[:number_journal] + [f'{phone};\n'] + \
#             data_second[number_journal + 1:]
#             with open('data_second_variant.csv', 'w', encoding='utf-8') as file:
#                 file.write(''.join(data_second))
#         if result == 4:
#             address = []
#             address  = data_second[number_journal].split(';')
#             address[result-1] = address_data()
#             data_second = data_second[:number_journal] + [f'{address};\n'] + \
#             data_second[number_journal + 1:]
#             with open('data_second_variant.csv', 'w', encoding='utf-8') as file:
#                 file.write(''.join(data_second))
#         # else:
